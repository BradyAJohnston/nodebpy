...
You can override this behaviour by being explicit with the socket you are passing out (`AccumulateField().o.total`) or using the `...` for the inputs into the next node.
