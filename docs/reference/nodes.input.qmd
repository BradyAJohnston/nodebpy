...
| [HandleTypeSelection](#nodebpy.nodes.input.HandleTypeSelection) | Provide a selection based on the handle types of Bézier control points |
...
| Name | Description |
| --- | --- |
| [collection](#nodebpy.nodes.input.Collection.collection) |  |
...
```python
nodes.input.CurveOfPoint(point_index=None)
```
...
| Name | Description |
| --- | --- |
| [i_face_group_id](#nodebpy.nodes.input.FaceGroupBoundaries.i_face_group_id) | Input socket: Face Group ID |
...
### HandleTypeSelection { #nodebpy.nodes.input.HandleTypeSelection }

```python
nodes.input.HandleTypeSelection(handle_type='AUTO', left=True, right=True)
```
...
| Name | Description |
| --- | --- |
| [handle_type](#nodebpy.nodes.input.HandleTypeSelection.handle_type) |  |
| [left](#nodebpy.nodes.input.HandleTypeSelection.left) |  |
| [mode](#nodebpy.nodes.input.HandleTypeSelection.mode) |  |
| [name](#nodebpy.nodes.input.HandleTypeSelection.name) |  |
| [node](#nodebpy.nodes.input.HandleTypeSelection.node) |  |
| [o_selection](#nodebpy.nodes.input.HandleTypeSelection.o_selection) | Output socket: Selection |
| [right](#nodebpy.nodes.input.HandleTypeSelection.right) |  |
| [tree](#nodebpy.nodes.input.HandleTypeSelection.tree) |  |
| [type](#nodebpy.nodes.input.HandleTypeSelection.type) |  |
...
```python
nodes.input.IsFacePlanar(threshold=0.001)
```
...
| [object](#nodebpy.nodes.input.Object.object) |  |
...
```python
nodes.input.OffsetPointInCurve(point_index=None, offset=0)
```
...
```python
nodes.input.PointsOfCurve(curve_index=None, weights=None, sort_index=0)
```
...
| Name | Description |
| --- | --- |
| [name](#nodebpy.nodes.input.Value.name) |  |
| [node](#nodebpy.nodes.input.Value.node) |  |
| [o_value](#nodebpy.nodes.input.Value.o_value) | Output socket: Value |
| [tree](#nodebpy.nodes.input.Value.tree) |  |
| [type](#nodebpy.nodes.input.Value.type) |  |
