...
| [i_group_index](#nodebpy.nodes.converter.FieldMinMax.i_group_index) | Input socket: Group ID |
...
| Name | Description |
| --- | --- |
| [edge](#nodebpy.nodes.converter.FieldMinMax.edge) | Create Field Min & Max with operation 'Edge'. |
| [face](#nodebpy.nodes.converter.FieldMinMax.face) | Create Field Min & Max with operation 'Face'. |
| [float](#nodebpy.nodes.converter.FieldMinMax.float) | Create Field Min & Max with operation 'Float'. |
| [instance](#nodebpy.nodes.converter.FieldMinMax.instance) | Create Field Min & Max with operation 'Instance'. |
| [integer](#nodebpy.nodes.converter.FieldMinMax.integer) | Create Field Min & Max with operation 'Integer'. |
| [layer](#nodebpy.nodes.converter.FieldMinMax.layer) | Create Field Min & Max with operation 'Layer'. |
| [point](#nodebpy.nodes.converter.FieldMinMax.point) | Create Field Min & Max with operation 'Point'. |
| [spline](#nodebpy.nodes.converter.FieldMinMax.spline) | Create Field Min & Max with operation 'Spline'. |
| [vector](#nodebpy.nodes.converter.FieldMinMax.vector) | Create Field Min & Max with operation 'Vector'. |

##### edge { #nodebpy.nodes.converter.FieldMinMax.edge }

```python
nodes.converter.FieldMinMax.edge(value=None, group_index=0)
```
...
```python
nodes.converter.FieldMinMax.face(value=None, group_index=0)
```

Create Field Min & Max with operation 'Face'.

##### float { #nodebpy.nodes.converter.FieldMinMax.float }

```python
nodes.converter.FieldMinMax.float(value=0.0, group_index=0)
```
...
```python
nodes.converter.FieldMinMax.instance(value=None, group_index=0)
```

Create Field Min & Max with operation 'Instance'.

##### integer { #nodebpy.nodes.converter.FieldMinMax.integer }

```python
nodes.converter.FieldMinMax.integer(value=0, group_index=0)
```
...
```python
nodes.converter.FieldMinMax.layer(value=None, group_index=0)
```
...
```python
nodes.converter.FieldMinMax.point(value=None, group_index=0)
```
...
```python
nodes.converter.FieldMinMax.spline(value=None, group_index=0)
```

Create Field Min & Max with operation 'Spline'.

##### vector { #nodebpy.nodes.converter.FieldMinMax.vector }

```python
nodes.converter.FieldMinMax.vector(value=None, group_index=0)
```
