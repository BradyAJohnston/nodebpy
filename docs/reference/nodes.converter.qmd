...
| Name | Description |
| --- | --- |
| [exclusive_or](#nodebpy.nodes.converter.BitMath.exclusive_or) | Create Bit Math with operation 'Exclusive Or'. |
...
##### exclusive_or { #nodebpy.nodes.converter.BitMath.exclusive_or }
...
| [not_and](#nodebpy.nodes.converter.BooleanMath.not_and) | Create Boolean Math with operation 'Not And'. |
| [not_equal](#nodebpy.nodes.converter.BooleanMath.not_equal) | Create Boolean Math with operation 'Not Equal'. |
...
##### not_and { #nodebpy.nodes.converter.BooleanMath.not_and }
...
##### not_equal { #nodebpy.nodes.converter.BooleanMath.not_equal }
...
| [divide_ceiling](#nodebpy.nodes.converter.IntegerMath.divide_ceiling) | Create Integer Math with operation 'Divide Ceiling'. |
...
| [multiply_add](#nodebpy.nodes.converter.IntegerMath.multiply_add) | Create Integer Math with operation 'Multiply Add'. |
...
##### divide_ceiling { #nodebpy.nodes.converter.IntegerMath.divide_ceiling }
...
##### multiply_add { #nodebpy.nodes.converter.IntegerMath.multiply_add }
...
| [floored_modulo](#nodebpy.nodes.converter.Math.floored_modulo) | Create Math with operation 'Floored Modulo'. |
| [fraction](#nodebpy.nodes.converter.Math.fraction) | Create Math with operation 'Fraction'. |
| [greater_than](#nodebpy.nodes.converter.Math.greater_than) | Create Math with operation 'Greater Than'. |
| [hyperbolic_cosine](#nodebpy.nodes.converter.Math.hyperbolic_cosine) | Create Math with operation 'Hyperbolic Cosine'. |
| [hyperbolic_sine](#nodebpy.nodes.converter.Math.hyperbolic_sine) | Create Math with operation 'Hyperbolic Sine'. |
| [hyperbolic_tangent](#nodebpy.nodes.converter.Math.hyperbolic_tangent) | Create Math with operation 'Hyperbolic Tangent'. |
| [inverse_square_root](#nodebpy.nodes.converter.Math.inverse_square_root) | Create Math with operation 'Inverse Square Root'. |
| [less_than](#nodebpy.nodes.converter.Math.less_than) | Create Math with operation 'Less Than'. |
...
| [multiply_add](#nodebpy.nodes.converter.Math.multiply_add) | Create Math with operation 'Multiply Add'. |
| [ping_pong](#nodebpy.nodes.converter.Math.ping_pong) | Create Math with operation 'Ping-Pong'. |
...
| [smooth_maximum](#nodebpy.nodes.converter.Math.smooth_maximum) | Create Math with operation 'Smooth Maximum'. |
| [smooth_minimum](#nodebpy.nodes.converter.Math.smooth_minimum) | Create Math with operation 'Smooth Minimum'. |
| [snap](#nodebpy.nodes.converter.Math.snap) | Create Math with operation 'Snap'. |
| [square_root](#nodebpy.nodes.converter.Math.square_root) | Create Math with operation 'Square Root'. |
...
| [to_degrees](#nodebpy.nodes.converter.Math.to_degrees) | Create Math with operation 'To Degrees'. |
| [to_radians](#nodebpy.nodes.converter.Math.to_radians) | Create Math with operation 'To Radians'. |
| [truncate](#nodebpy.nodes.converter.Math.truncate) | Create Math with operation 'Truncate'. |
| [truncated_modulo](#nodebpy.nodes.converter.Math.truncated_modulo) | Create Math with operation 'Truncated Modulo'. |
...
##### hyperbolic_cosine { #nodebpy.nodes.converter.Math.hyperbolic_cosine }
...
##### hyperbolic_sine { #nodebpy.nodes.converter.Math.hyperbolic_sine }
...
##### hyperbolic_tangent { #nodebpy.nodes.converter.Math.hyperbolic_tangent }
...
##### inverse_square_root { #nodebpy.nodes.converter.Math.inverse_square_root }
...
##### smooth_maximum { #nodebpy.nodes.converter.Math.smooth_maximum }
...
##### smooth_minimum { #nodebpy.nodes.converter.Math.smooth_minimum }
...
##### square_root { #nodebpy.nodes.converter.Math.square_root }
...
##### to_degrees { #nodebpy.nodes.converter.Math.to_degrees }
...
##### to_radians { #nodebpy.nodes.converter.Math.to_radians }
