...
| [FieldMinMax](#nodebpy.nodes.manual.FieldMinMax) | Calculate the minimum and maximum of a given field |
...
| [MeshBoolean](#nodebpy.nodes.manual.MeshBoolean) | Cut, subtract, or join multiple mesh inputs |
...
### FieldMinMax { #nodebpy.nodes.manual.FieldMinMax }

```python
nodes.manual.FieldMinMax(
    value=1.0,
    group_index=0,
    *,
    data_type='FLOAT',
...
| Name | Description |
| --- | --- |
| [corner](#nodebpy.nodes.manual.FieldMinMax.corner) |  |
| [data_type](#nodebpy.nodes.manual.FieldMinMax.data_type) |  |
| [domain](#nodebpy.nodes.manual.FieldMinMax.domain) |  |
| [edge](#nodebpy.nodes.manual.FieldMinMax.edge) |  |
| [face](#nodebpy.nodes.manual.FieldMinMax.face) |  |
| [i_group_id](#nodebpy.nodes.manual.FieldMinMax.i_group_id) | Input socket: Group ID |
| [i_value](#nodebpy.nodes.manual.FieldMinMax.i_value) | Input socket: Value |
| [instance](#nodebpy.nodes.manual.FieldMinMax.instance) |  |
| [layer](#nodebpy.nodes.manual.FieldMinMax.layer) |  |
| [name](#nodebpy.nodes.manual.FieldMinMax.name) |  |
| [node](#nodebpy.nodes.manual.FieldMinMax.node) |  |
| [o_max](#nodebpy.nodes.manual.FieldMinMax.o_max) | Output socket: Max |
| [o_min](#nodebpy.nodes.manual.FieldMinMax.o_min) | Output socket: Min |
| [point](#nodebpy.nodes.manual.FieldMinMax.point) |  |
| [spline](#nodebpy.nodes.manual.FieldMinMax.spline) |  |
| [tree](#nodebpy.nodes.manual.FieldMinMax.tree) |  |
| [type](#nodebpy.nodes.manual.FieldMinMax.type) |  |
...
### MeshBoolean { #nodebpy.nodes.manual.MeshBoolean }

```python
nodes.manual.MeshBoolean(
    *args,
...
| Name | Description |
| --- | --- |
| [i_mesh_1](#nodebpy.nodes.manual.MeshBoolean.i_mesh_1) | Input socket: Mesh 1 |
| [i_mesh_2](#nodebpy.nodes.manual.MeshBoolean.i_mesh_2) | Input socket: Mesh 2 |
| [name](#nodebpy.nodes.manual.MeshBoolean.name) |  |
| [node](#nodebpy.nodes.manual.MeshBoolean.node) |  |
| [o_intersecting_edges](#nodebpy.nodes.manual.MeshBoolean.o_intersecting_edges) | Output socket: Mesh |
| [o_mesh](#nodebpy.nodes.manual.MeshBoolean.o_mesh) | Output socket: Mesh |
| [operation](#nodebpy.nodes.manual.MeshBoolean.operation) |  |
| [solver](#nodebpy.nodes.manual.MeshBoolean.solver) |  |
| [tree](#nodebpy.nodes.manual.MeshBoolean.tree) |  |
| [type](#nodebpy.nodes.manual.MeshBoolean.type) |  |

#### Methods

| Name | Description |
| --- | --- |
| [difference](#nodebpy.nodes.manual.MeshBoolean.difference) | Create Mesh Boolean with operation 'Difference'. |
| [intersect](#nodebpy.nodes.manual.MeshBoolean.intersect) |  |
| [m_difference](#nodebpy.nodes.manual.MeshBoolean.m_difference) |  |
| [m_union](#nodebpy.nodes.manual.MeshBoolean.m_union) |  |
| [union](#nodebpy.nodes.manual.MeshBoolean.union) | Create Mesh Boolean with operation 'Union'. |

##### difference { #nodebpy.nodes.manual.MeshBoolean.difference }

```python
nodes.manual.MeshBoolean.difference(mesh_1=None, mesh_2=None)
```
...
```python
nodes.manual.MeshBoolean.intersect(
    *args,
...
```python
nodes.manual.MeshBoolean.m_difference(
    *args,
    mesh_1=None,
    hole_tolerant=False,
    self_intersection=False,
...
```python
nodes.manual.MeshBoolean.m_union(
    *args,
    hole_tolerant=False,
    self_intersection=False,
    solver='FLOAT',
...
##### union { #nodebpy.nodes.manual.MeshBoolean.union }

```python
nodes.manual.MeshBoolean.union(mesh_1=None, mesh_2=None)
```
