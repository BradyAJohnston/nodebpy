...
class Jitter(builder.NodeGroupBuilder):
    ...
    @property
    def i_geometry(self) -> builder.IntegerSocketLinker:
        return self.inputs.get("Geometry")
    
    @property
    def i_amount(self) -> builder.SocketLinker:
        return self.inputs.get("Amount")
    
    @property
    def i_seed(self) -> builder.IntegerSocketLinker:
        return self.inputs.get("Amount")
    
    @property
    def o_geometry(self) -> builder.SocketLinker:
