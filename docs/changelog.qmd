...
- Zone extents in plots follow Blender's rule: everything upstream of the zone output (and downstream of its input) is inside the zone, so feeders of a node inside a closure zone are drawn within it.
