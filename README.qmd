...
Most node classes are generated automatically with this.
The nodes in `nodes/manual.py` are currently manually specified due to varying complexities of particular nodes (usually lergacy).
