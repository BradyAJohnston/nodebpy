...
The package is available on PyPI [here](https://pypi.org/project/nodebpy/). You can install it and use it in your own projects using `pip` or your preferred package manager, I recommend [uv](https://docs.astral.sh/uv/).
...
Pair it with `to_python(in_place=True)`, whose header rebuilds the exported tree in the same datablock (see [Nodes to Code](nodes-to-code.llms.md#in-place)).
