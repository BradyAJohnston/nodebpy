...
class Arc(BaseNode):
    ...
    def __init__(
        ...
        start: InputVector = (-1.0, 0.0, 0.0),
        middle: InputVector = (0.0, 2.0, 0.0),
        end: InputVector = (1.0, 0.0, 0.0),
        radius: InputFloat = 1.0,
        start_angle: InputFloat = 0.0,
        sweep_angle: InputFloat = 7 * math.pi / 4,
...
class BezierSegment(BaseNode):
    ...
    def __init__(
        ...
        resolution: InputInteger = 16,
        start: InputVector = (-1.0, 0.0, 0.0),
        start_handle: InputVector = (-0.5, 0.5, 0.0),
        end_handle: InputVector = (0.0, 0.0, 0.0),
        end: InputVector = (1.0, 0.0, 0.0),
        *,
...
class CurveCircle(BaseNode):
    ...
    def __init__(
        ...
        point_1: InputVector = (-1.0, 0.0, 0.0),
        point_2: InputVector = (0.0, 1.0, 0.0),
        point_3: InputVector = (1.0, 0.0, 0.0),
        radius: InputFloat = 1.0,
        *,
        mode: Literal["POINTS", "RADIUS"] = "RADIUS",
    ):
...
class CurveLine(BaseNode):
    ...
    def __init__(
        self,
        start: InputVector = (0.0, 0.0, 0.0),
        end: InputVector = (0.0, 0.0, 1.0),
    ...
    @classmethod
    def points(
        cls, start: InputVector = (0.0, 0.0, 0.0), end: InputVector = (0.0, 0.0, 1.0)
    ) -> "CurveLine":
...
class GetGeometryComponent(BaseNode):
    ...
    node: bpy.types.GeometryNodeGetGeometryComponent
...
class MeshBevel(BaseNode):
    ...
    node: bpy.types.GeometryNodeMeshBevel
...
class Quadrilateral(BaseNode):
    ...
    def __init__(
        ...
        point_1: InputVector = (-1.0, -1.0, 0.0),
        point_2: InputVector = (1.0, -1.0, 0.0),
        point_3: InputVector = (1.0, 1.0, 0.0),
        point_4: InputVector = (-1.0, 1.0, 0.0),
        *,
        mode: Literal[
...
class SampleNearestSurface[T](BaseNode):
    """
...
class SampleUVSurface[T](BaseNode):
    """
