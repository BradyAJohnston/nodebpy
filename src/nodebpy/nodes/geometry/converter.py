...
from .._mixins import (
    ...
    _FieldToListMixin,
    _FormatStringMixin,
    _SeparateBundleMixin,
)


class AccumulateField[T](BaseNode):
    """
...
class EvaluateAtIndex[T](BaseNode):
    """
...
class FilterList[T](BaseNode):
    ...
    node: bpy.types.GeometryNodeFilterList
...
class SetStringCase(BaseNode):
    ...
    node: bpy.types.FunctionNodeSetStringCase
...
class SortList[T](BaseNode):
    ...
    node: bpy.types.GeometryNodeSortList
...
class StringToValue[T](BaseNode):
    """
...
class ValueToString[T](BaseNode):
    """
